...
The **'Movement Processing'** window lists all the claims that have been initiated from the members register. From this window, benefits for claim record are calculated and transactions are certified. See screenshot below:
...
After benefits calculations and processing, all claim records for different members under different exit categories are listed in the **'Claim Payments'** window awaiting disbursement of money. See screenshot below:
...
-   Click the **'Print'** menu and from the drop-down menu select the type of report to view.

-   click the **'More Options'** menu and from the drop-down menu, select an action to execute.
